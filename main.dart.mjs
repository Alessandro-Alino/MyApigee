...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1365: (x0,x1) => x0.querySelector(x1),
      _1366: x0 => ({type: x0}),
      _1367: (x0,x1) => new Blob(x0,x1),
      _1368: x0 => globalThis.URL.createObjectURL(x0),
      ...
      _1440: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1442: o => o instanceof Uint8Array,
      _1443: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1444: o => o instanceof Int8Array,
      _1445: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1446: o => o instanceof Uint8ClampedArray,
      _1447: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1448: o => o instanceof Uint16Array,
      _1449: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1450: o => o instanceof Int16Array,
      _1451: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1452: o => o instanceof Uint32Array,
      _1453: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1454: o => o instanceof Int32Array,
      _1455: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1457: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1458: o => o instanceof Float32Array,
      _1459: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1460: o => o instanceof Float64Array,
      _1461: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1462: (t, s) => t.set(s),
      _1464: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1466: o => o.buffer,
      _1467: o => o.byteOffset,
      _1468: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1469: (b, o) => new DataView(b, o),
      _1470: (b, o, l) => new DataView(b, o, l),
      _1471: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1472: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1473: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1474: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1475: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1476: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1477: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1478: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1479: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1480: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1481: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1482: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1485: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1486: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1487: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1488: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1489: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1490: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1503: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1504: (handle) => clearTimeout(handle),
      _1505: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1506: (handle) => clearInterval(handle),
      _1507: (c) =>
      ...
      _1542: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1542(f,arguments.length,x0,x1) }),
      _1543: o => {
      ...
      _1586: (x0,x1) => new WebSocket(x0,x1),
      _1587: (x0,x1) => x0.send(x1),
      _1588: (x0,x1,x2) => x0.close(x1,x2),
      _1589: (x0,x1) => x0.close(x1),
      _1590: x0 => x0.close(),
      _1594: () => new AbortController(),
      _1595: x0 => x0.abort(),
      _1596: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1597: (x0,x1) => globalThis.fetch(x0,x1),
      _1598: (x0,x1) => x0.get(x1),
      _1599: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1599(f,arguments.length,x0,x1,x2) }),
      _1600: (x0,x1) => x0.forEach(x1),
      _1601: x0 => x0.getReader(),
      _1602: x0 => x0.read(),
      _1603: x0 => x0.cancel(),
      _1604: x0 => new BroadcastChannel(x0),
      _1605: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1605(f,arguments.length,x0) }),
      _1606: (x0,x1) => x0.postMessage(x1),
      _1607: x0 => x0.close(),
      _1611: (x0,x1) => x0.key(x1),
      _1612: x0 => x0.random(),
      _1615: () => globalThis.Math,
      ...
      _1782: (x0,x1) => { x0.draggable = x1 },
      _1798: x0 => x0.style,
      _2157: (x0,x1) => { x0.download = x1 },
      _2182: (x0,x1) => { x0.href = x1 },
      _2727: (x0,x1) => { x0.accept = x1 },
      _2741: x0 => x0.files,
      _2767: (x0,x1) => { x0.multiple = x1 },
      _2785: (x0,x1) => { x0.type = x1 },
      _3504: () => globalThis.window,
      _3547: x0 => x0.location,
      _3548: x0 => x0.history,
      _3566: x0 => x0.navigator,
      _3830: x0 => x0.localStorage,
      _3838: x0 => x0.href,
      _3953: x0 => x0.userAgent,
      _4004: x0 => x0.data,
      _4051: (x0,x1) => { x0.onmessage = x1 },
      _4158: x0 => x0.length,
      _4375: x0 => x0.readyState,
      _4388: (x0,x1) => { x0.binaryType = x1 },
      _4391: x0 => x0.code,
      _4392: x0 => x0.reason,
      _6100: x0 => x0.signal,
      _6161: x0 => x0.firstChild,
      _6172: () => globalThis.document,
      _6254: x0 => x0.body,
      _6587: (x0,x1) => { x0.id = x1 },
      _6614: x0 => x0.children,
      _7933: x0 => x0.value,
      _7935: x0 => x0.done,
      _8115: x0 => x0.size,
      _8116: x0 => x0.type,
      ...
      _8631: x0 => x0.url,
      _8633: x0 => x0.status,
      _8635: x0 => x0.statusText,
      _8636: x0 => x0.headers,
      _8637: x0 => x0.body,
      _11043: (x0,x1) => { x0.display = x1 },
      _12265: x0 => x0.name,
