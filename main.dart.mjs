...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1301: (x0,x1) => x0.getItem(x1),
      _1303: (x0,x1,x2) => x0.setItem(x1,x2),
      ...
      _1309: () => new FileReader(),
      _1311: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1312: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1312(f,arguments.length,x0) }),
      _1313: (x0,x1,x2) => x0.removeEventListener(x1,x2),
      ...
      _1453: (x0,x1) => new WebSocket(x0,x1),
      _1454: (x0,x1) => x0.send(x1),
      _1455: (x0,x1,x2) => x0.close(x1,x2),
      _1456: (x0,x1) => x0.close(x1),
      _1457: x0 => x0.close(),
      _1458: () => new AbortController(),
      _1459: x0 => x0.abort(),
      _1460: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1461: (x0,x1) => globalThis.fetch(x0,x1),
      _1462: (x0,x1) => x0.get(x1),
      _1463: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1463(f,arguments.length,x0,x1,x2) }),
      _1464: (x0,x1) => x0.forEach(x1),
      _1465: x0 => x0.getReader(),
      _1466: x0 => x0.read(),
      _1467: x0 => x0.cancel(),
      _1468: x0 => new BroadcastChannel(x0),
      _1469: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1469(f,arguments.length,x0) }),
      _1470: (x0,x1) => x0.postMessage(x1),
      _1471: x0 => x0.close(),
      ...
      _1724: (x0,x1) => { x0.draggable = x1 },
      _1740: x0 => x0.style,
      _2099: (x0,x1) => { x0.download = x1 },
      _2124: (x0,x1) => { x0.href = x1 },
      _2669: (x0,x1) => { x0.accept = x1 },
      _2683: x0 => x0.files,
      _2709: (x0,x1) => { x0.multiple = x1 },
      _2727: (x0,x1) => { x0.type = x1 },
      _3446: () => globalThis.window,
      _3489: x0 => x0.location,
      _3490: x0 => x0.history,
      _3508: x0 => x0.navigator,
      _3772: x0 => x0.localStorage,
      _3780: x0 => x0.href,
      _3895: x0 => x0.userAgent,
      _3946: x0 => x0.data,
      _3993: (x0,x1) => { x0.onmessage = x1 },
      _4100: x0 => x0.length,
      _4317: x0 => x0.readyState,
      _4330: (x0,x1) => { x0.binaryType = x1 },
      _4333: x0 => x0.code,
      _4334: x0 => x0.reason,
      _6042: x0 => x0.signal,
      _6103: x0 => x0.firstChild,
      _6114: () => globalThis.document,
      _6196: x0 => x0.body,
      _6529: (x0,x1) => { x0.id = x1 },
      _6556: x0 => x0.children,
      _7875: x0 => x0.value,
      _7877: x0 => x0.done,
      _8057: x0 => x0.size,
      _8058: x0 => x0.type,
      ...
      _8573: x0 => x0.url,
      _8575: x0 => x0.status,
      _8577: x0 => x0.statusText,
      _8578: x0 => x0.headers,
      _8579: x0 => x0.body,
      _10985: (x0,x1) => { x0.display = x1 },
      _12207: x0 => x0.name,
